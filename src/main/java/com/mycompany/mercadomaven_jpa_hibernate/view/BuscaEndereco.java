...
public class BuscaEndereco extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextFieldTitulo1.setText("Endereços");
        ...
        jTableBusca.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Logradouro", "CEP", "Bairro", "Cidade", "Status"
            }
        ) {
        ...
        if (jTableBusca.getColumnModel().getColumnCount() > 0) {
            ...
            jTableBusca.getColumnModel().getColumn(3).setMaxWidth(100);
