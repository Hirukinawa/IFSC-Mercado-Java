...
public class BuscaColaborador extends javax.swing.JDialog {

    /**
     * Creates new form BuscaColaborador
     */
    public BuscaColaborador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextFieldTitulo1.setText("Colaboradores");
        ...
        jTableBusca.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Login", "CEP", "Data de Cadastro", "Status"
            }
        ) {
        ...
        if (jTableBusca.getColumnModel().getColumnCount() > 0) {
            ...
            jTableBusca.getColumnModel().getColumn(1).setMaxWidth(300);
            jTableBusca.getColumnModel().getColumn(2).setMaxWidth(100);
            jTableBusca.getColumnModel().getColumn(3).setMaxWidth(75);
            jTableBusca.getColumnModel().getColumn(4).setMaxWidth(100);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaColaborador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscaColaborador dialog = new BuscaColaborador(new javax.swing.JFrame(), true);
