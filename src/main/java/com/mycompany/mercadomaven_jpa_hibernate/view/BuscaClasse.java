...
public class BuscaClasse extends javax.swing.JDialog {

    /**
     * Creates new form BuscaClasse
     */
    public BuscaClasse(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextFieldTitulo1.setText("Classes");
        ...
        if (jTableBusca.getColumnModel().getColumnCount() > 0) {
            ...
            jTableBusca.getColumnModel().getColumn(1).setMaxWidth(570);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaClasse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscaClasse dialog = new BuscaClasse(new javax.swing.JFrame(), true);
