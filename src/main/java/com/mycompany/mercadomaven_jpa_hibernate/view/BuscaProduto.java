...
public class BuscaProduto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextFieldTitulo1.setText("Produtos");
        ...
        jTableBusca.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Descrição", "Marca", "Classe", "Und Compra", "Und Venda", "Status"
            }
        ) {
        ...
        if (jTableBusca.getColumnModel().getColumnCount() > 0) {
            ...
            jTableBusca.getColumnModel().getColumn(1).setMaxWidth(260);
            jTableBusca.getColumnModel().getColumn(2).setMaxWidth(75);
            jTableBusca.getColumnModel().getColumn(3).setMaxWidth(75);
            jTableBusca.getColumnModel().getColumn(4).setMaxWidth(90);
            jTableBusca.getColumnModel().getColumn(5).setMaxWidth(90);
            jTableBusca.getColumnModel().getColumn(6).setMaxWidth(50);
        }
