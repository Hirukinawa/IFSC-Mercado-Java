...
public class BuscaCondicaoPgto extends javax.swing.JDialog {

    /**
     * Creates new form BuscaCondicaoPagto
     */
    public BuscaCondicaoPgto(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
    ...
    public JTable getjTableBuscaCond() {
        return jTableBuscaCond;
    }
    ...
    private void initComponents() {
        ...
        jTableBuscaCond = new javax.swing.JTable();
        ...
        jTableBusca.setForeground(new java.awt.Color(61, 64, 66));
        ...
        jTextFieldTitulo1.setText("Condições de Pagamento");
        ...
        jTableBuscaCond.setBackground(new java.awt.Color(61, 64, 66));
        jTableBuscaCond.setForeground(new java.awt.Color(255, 255, 255));
        jTableBuscaCond.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Descrição", "Num Parcelas", "Dia da 1ª Parcela", "Dias entre Parcelas", "Status"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jScrollPane3.setViewportView(jTableBuscaCond);
        if (jTableBuscaCond.getColumnModel().getColumnCount() > 0) {
            jTableBuscaCond.getColumnModel().getColumn(0).setMaxWidth(25);
            jTableBuscaCond.getColumnModel().getColumn(1).setMaxWidth(275);
            jTableBuscaCond.getColumnModel().getColumn(2).setMaxWidth(100);
            jTableBuscaCond.getColumnModel().getColumn(3).setMaxWidth(100);
            jTableBuscaCond.getColumnModel().getColumn(4).setMaxWidth(125);
            jTableBuscaCond.getColumnModel().getColumn(5).setMaxWidth(50);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaCondicaoPgto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscaCondicaoPgto dialog = new BuscaCondicaoPgto(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTableBuscaCond;
